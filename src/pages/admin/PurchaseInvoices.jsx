    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-600 mt-1">Track vendor purchases and payments</p>
        </div>
        <button onClick={() => { setForm({ invoiceNumber: '', vendorId: '', invoiceDate: '', items: [{ ...emptyItem }] }); setError(''); setModal('create'); }} className="btn-primary flex items-center gap-2 flex-shrink-0">
